...
/*   Updated: 2024/09/28 10:17:51 by mmaghri          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void PrintAswitch(std::string value){
    ...
    if (value.length() > 1) std::cout << "Char     :  Non displayable !" << std::endl ; 
    else {
...
void ScalarConverter::convert(std::string value){
    ...
    if (value == "-inff" || value == "+inff" || value == "nan") {printNans(value); return;}
    if (value.length() > 1) {
