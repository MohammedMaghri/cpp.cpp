...
/*   Updated: 2024/09/23 11:57:41 by mmaghri          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
PresidentialPardonForm::PresidentialPardonForm() : AForm("From_Shrubbery", 25, 15), target("Default"){ std::cout << "PresidentialPardonForm Cons" << std::endl;};
PresidentialPardonForm::PresidentialPardonForm(const std::string& value) : AForm("From_Shrubbery", 25, 15), target(value) {};
